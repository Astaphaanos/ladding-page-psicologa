    ...
    return (
        <section className="bg-[#9e3438] text-white p-10 h-auto" id="sobre-mim">
            <div className="flex flex-col items-center justify-center">
                <h2 className="text-4xl font-bold p-2">Sobre Mim</h2>
                <h3 className="text-2xl font-medium pb-6">Psicóloga credenciada CRP- 02/29522</h3>
                <p className="w-1/2 text-justify text-[18px]">
